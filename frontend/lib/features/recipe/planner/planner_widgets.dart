...
class MealPlanCard extends StatelessWidget {
	...
	@override
	Widget build(BuildContext context) {
		final sourceLabel = entry.isAutoGenerated ? 'Auto' : 'User';
		final sourceBg = entry.isAutoGenerated ? AppColors.primarySoft : AppColors.surfaceSoft;
		final sourceBorder = entry.isAutoGenerated ? AppColors.primary : AppColors.border;
		return Card(
			child: Padding(
						...
						Expanded(
							child: Column(
								...
								children: [
									...
									Text(
										context.trKey(
											L10nKeys.plannerServings,
											params: {'count': entry.servings},
										),
